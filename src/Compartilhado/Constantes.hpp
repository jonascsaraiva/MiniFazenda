...
constexpr int LARGURA_DA_UNIDADE_DE_OCUPACAO = LARGURA_DO_CANTEIRO / UNIDADES_DE_OCUPACAO_POR_CANTEIRO;
constexpr int ALTURA_DA_UNIDADE_DE_OCUPACAO = ALTURA_DO_CANTEIRO / UNIDADES_DE_OCUPACAO_POR_CANTEIRO;
